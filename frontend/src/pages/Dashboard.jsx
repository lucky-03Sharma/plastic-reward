...
export default function Dashboard() {
  ...
  const submitWaste = async () => {
    ...
    try {
      await axios.post("http://localhost:5000/api/waste/deposit", {
        userId: "PUT_YOUR_REAL_USER_ID",
        type: type,
      ...
      setMessage(error.response?.data?.error || "Failed to submit waste. Please try again.");
      setIsError(true);
    } finally {
      setLoading(false);
    }
